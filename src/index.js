...
document.addEventListener('headtrackrStatus', headtrackrStatus.bind(null, '#message'), true);
...
const htracker = new headtrackr.Tracker({ calcAngles: true, ui: false, headPosition: true });
