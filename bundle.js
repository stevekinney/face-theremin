...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libConfigureCanvasOverlay = __webpack_require__(2);

	var _libConfigureCanvasOverlay2 = _interopRequireDefault(_libConfigureCanvasOverlay);

	var _libSynthesizer = __webpack_require__(3);

	var _libSynthesizer2 = _interopRequireDefault(_libSynthesizer);

	var _libUpdateStatistics = __webpack_require__(4);

	var _libTrackingEvents = __webpack_require__(11);

	var _libPageElements = __webpack_require__(5);

	/* globals headtrackr */

	__webpack_require__(6);

	(0, _libConfigureCanvasOverlay2['default'])(_libPageElements.canvasOverlay);

	document.addEventListener('headtrackrStatus', _libTrackingEvents.headtrackrStatus.bind(null, '#message'), true);
	document.addEventListener('facetrackingEvent', _libTrackingEvents.facetrackingEvent);
	document.addEventListener('facetrackingEvent', _libUpdateStatistics.updateFaceStatistics);
	document.addEventListener('facetrackingEvent', _libSynthesizer2['default'].update.bind(_libSynthesizer2['default']));

	var htracker = new headtrackr.Tracker({ calcAngles: true, ui: false, headPosition: true });
	htracker.init(_libPageElements.videoInput, _libPageElements.canvasInput);
	htracker.start();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
	  ...
	  return "<table>\n  <tr>\n    <th>Frequency</th>\n    <td>"
	    + alias3(((helper = (helper = helpers.frequency || (depth0 != null ? depth0.frequency : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"frequency","hash":{},"data":data}) : helper)))
	    + "</td>\n  </tr>\n  <tr>\n    <th>Gain</th>\n    <td>"
	    + alias3(((helper = (helper = helpers.gain || (depth0 != null ? depth0.gain : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"gain","hash":{},"data":data}) : helper)))
	    + "</td>\n  </tr>\n</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (canvasOverlay) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _audioContext = __webpack_require__(8);

	var _audioContext2 = _interopRequireDefault(_audioContext);

	var _updateStatistics = __webpack_require__(4);

	var oscillator = _audioContext2['default'].createOscillator();
	var gainNode = _audioContext2['default'].createGain();
	...
	exports['default'] = {
	  ...
	  update: function update(_ref) {
	    ...
	    (0, _updateStatistics.updateSynthStatistics)(format(frequency, gain));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.updateFaceStatistics = updateFaceStatistics;
	exports.updateSynthStatistics = updateSynthStatistics;
	...
	var $faceStatistics = (0, _jquery2['default'])('#face-statistics');
	var $synthStatistics = (0, _jquery2['default'])('#synth-statistics');

	var synthStatisticsTemplate = __webpack_require__(1);
	var faceStatisticsTemplate = __webpack_require__(12);

	function updateFaceStatistics(data) {
	  $faceStatistics.html(faceStatisticsTemplate(data));
	}

	function updateSynthStatistics(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _synthesizer = __webpack_require__(3);
	...
	(0, _jquery2['default'])(onOffButton).click(function () {

	  (0, _jquery2['default'])(this).toggleClass('off');

	  if ((0, _jquery2['default'])(this).hasClass('off')) {
	    (0, _jquery2['default'])(this).text('Off');
	    _synthesizer2['default'].start();
	  } else {
	    (0, _jquery2['default'])(this).text('On');
	    _synthesizer2['default'].stop();
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.headtrackrStatus = headtrackrStatus;
	exports.facetrackingEvent = facetrackingEvent;

	var _pageElements = __webpack_require__(5);

	var _messages = __webpack_require__(22);

	function headtrackrStatus(selector, _ref) {
	  var status = _ref.status;

	  var element = document.querySelector(selector);
	  if (status in _messages.statusMessages) {
	    element.innerHTML = _messages.statusMessages[status];
	  }
	}

	function facetrackingEvent(_ref2) {
	  var x = _ref2.x;
	  var y = _ref2.y;
	  var angle = _ref2.angle;
	  var detection = _ref2.detection;
	  var width = _ref2.width;
	  var height = _ref2.height;
	  var context = arguments[1] === undefined ? _pageElements.overlayContext : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SafeString = __webpack_require__(18);
	...
	var _import3 = __webpack_require__(20);

	var runtime = _interopRequireWildcard(_import3);

	var _noConflict = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statusMessages = {
	  'whitebalance': 'Alright, we\'re checking for the stability of camera\'s whitebalance.',
	  'detecting': 'Detecting your beautiful face.',
	  'hints': 'Hmm. Detecting the your face is taking a long time. It\'s not you, it\'s me.',
	  'redetecting': 'Lost track of your gorgeous face. Give me a second to redetect it.',
	  'lost': 'We\'ve lost your wonderful face.',
	...
	exports.supportMessages = supportMessages;
