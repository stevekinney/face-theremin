...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('headtrackrStatus', _libTrackingEvents.headtrackrStatus, true);
	...
	var htracker = new headtrackr.Tracker({ calcAngles: true, ui: true, headPosition: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.headtrackerStatus = headtrackerStatus;
	exports.facetrackingEvent = facetrackingEvent;

	var _pageElementsJs = __webpack_require__(5);

	function headtrackerStatus() {
	  console.log(event.status);
	}

	function facetrackingEvent(_ref) {
	  var x = _ref.x;
	  var y = _ref.y;
	  ...
	  var height = _ref.height;
	  var context = arguments[1] === undefined ? _pageElementsJs.overlayContext : arguments[1];
